...
export class ProjectUpdateEditComponent implements OnInit {
    ...
    ngOnInit() {
		this.route.params.forEach((params: Params) => {
			...
			this.projectService.getProjectUpdateById(this.projectId, this.updateId, isLoggedIn)
					.subscribe(
	...
	editProjectUpdate() {
		...
		this.projectService.editProjectUpdate(this.projectId, this.updateId, this.projectUpdateFromServer)
			.subscribe(
				(data) => {
	...
	deleteProjectUpdate() {
		...
		if (!r) {
			...
			this.projectService.deleteProjectUpdate(this.projectId, this.updateId)
					.subscribe(
						(data) => {
